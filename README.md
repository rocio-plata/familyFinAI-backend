...
- `Budgeting`: dominio inicial y `CreateBudgetConfiguration` implementados con pruebas; quedan pendientes los demás casos de uso, persistencia propia, handlers y rutas.
