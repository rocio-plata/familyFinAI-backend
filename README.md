...
- `Budgeting`: dominio inicial y `CreateBudgetConfiguration`, `UpdateDefaultBudgetAmount` y `SetBudgetOverrideForPeriod` implementados con pruebas; quedan pendientes los demás casos de uso, persistencia propia, handlers y rutas.
