...
- **Financial Tracking**: casos de uso y entidades/value objects centrales implementados; `POST /families/:familyId/categories` ✅, `GET /families/:familyId/categories` ✅, `POST /families/:familyId/categories/:categoryId/tags` ✅, `PATCH /families/:familyId/categories/:categoryId` ✅, `PATCH /families/:familyId/categories/:categoryId/tags/:tagId` ✅, `PUT /families/:familyId/categories/:categoryId/tags/order` ✅, `POST /families/:familyId/categories/:categoryId/deprecate` ✅, `POST /families/:familyId/categories/:categoryId/tags/:tagId/deprecate` ✅ y `DELETE /families/:familyId/categories/:categoryId` ✅ son los primeros endpoints expuestos. **Budgeting, Reporting y AI Assistance**: documentados, con sus entidades/value objects centrales implementados, pero sin rutas HTTP todavía.
