...
> **Estado de implementación**: los 17 casos de uso de este documento (1–22) ya están implementados en `src/contexts/financial-tracking/application/`, con sus tests correspondientes en `tests/contexts/financial-tracking/`. Las secciones de "Errores" y "Pendientes" al final de este documento reflejan las decisiones ya tomadas durante la implementación.
...
> Nota: los puntos 1–5 quedaron resueltos durante la implementación de los 22 casos de uso; se dejan documentados como registro de la decisión tomada. El punto 6 sigue abierto.
