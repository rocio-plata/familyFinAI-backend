...
13b. **`DeprecatePaymentMethodUseCase`, `DeletePaymentMethodUseCase`** — `DeprecatePaymentMethodUseCase` ✅ implementado con tests TDD, incluyendo el rechazo por `PaymentMethodIsSomeonesDefaultError`. `DeletePaymentMethodUseCase` sigue pendiente.
