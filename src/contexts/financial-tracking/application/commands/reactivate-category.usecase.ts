// src/contexts/financial-tracking/application/commands/reactivate-category.usecase.ts
...
class ReactivateCategoryUseCase {
  ...
  async execute(input: ReactivateCategoryInput): Promise<Category> {
    // 1. Solo un Owner puede reactivar categorías
...
export { ReactivateCategoryUseCase };
